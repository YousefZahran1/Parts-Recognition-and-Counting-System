...
best_knn_classifier = train_knn(X_pca_train, Y_train, n_neighbors=5)

# Evaluation and visualization
accuracy_best, classification_report_best, confusion_matrix_best = evaluate_model(best_knn_classifier, X_pca_test, Y_test)
